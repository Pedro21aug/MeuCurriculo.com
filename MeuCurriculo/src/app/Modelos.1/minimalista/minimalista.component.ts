...
@Component({
  selector: 'app-minimalista',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './minimalista.component.html',
  styleUrl: './minimalista.component.css'
})
export class MinimalistaComponent implements OnInit {

  // DECLARAÇÃO DE VARIÁVEIS PARA INPUTS DO FORMULÁRIO //
